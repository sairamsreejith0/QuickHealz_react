...
import "../Caretaker_styles/CaretakerRegister.css";
const CaretakerRegistrationForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('http://127.0.0.1:8000/api/caretaker/', formData)
      .then(response => {
  ...
  return (
    <form onSubmit={handleSubmit}>
       <h1><center><b>CaretakerRegistration</b></center></h1>
